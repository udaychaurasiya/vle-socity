                ...
                child: Column(
                  children: [
                    Obx(() => controller.certificateModel.value.data != null
                        ? ListView.builder(
                            shrinkWrap: true,
                            itemCount: controller.certificateModel.value.data!.length,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              //       color: Colors.grey),
                                              // ),
                                              Text("issued on ",style: TextStyle(fontSize: 12.sp,color: Colors.grey),),
                                              Text(data.addDate.toString().length>19?data.addDate.toString().substring(0,19):data.addDate.toString(),style: TextStyle(fontSize: 12.sp,color: Colors.grey)),
                                              Spacer(),
                                              InkWell(
                                                  onTap: ()
                                                async
