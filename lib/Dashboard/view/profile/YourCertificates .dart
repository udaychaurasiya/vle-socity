                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text("For completion of EAE",style: TextStyle(fontSize: 13.sp,
                                                  color: Colors.grey.shade700),)
                                            ],
                                          ),
                                          Spacer(),
                                          IconButton(onPressed: (){},icon: Icon(Icons.share_sharp,size: 18.sp,),)
                                        ],
                                      ),SizedBox(height: 10.h,),
                                      Row(
                                        children: [
                                          Text("issued on 17-05-2022",style: TextStyle(fontSize: 12.sp,
                                              color: Colors.grey),),
                                          Spacer(),
                                          InkWell(
                                              onTap: generatePdf,
