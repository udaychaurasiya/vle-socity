...
class MyAsk extends StatefulWidget {MyAsk({super.key});
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      [
                                        ...
                                        //                 content: Text("Are you sure delete"+controller.myAskModel.value.data![index].id.toString()),
                                        //                 actions: <Widget>[
                                        //                   TextButton(
                                        //                     onPressed: () {
                                        ...
                                        //                   TextButton(
                                        //                     onPressed: ()  async{
                                        //                      controller.deletePostCommunityApi(controller.myAskModel.value.data![index].id.toString());
                                        //
                                        //                       // if(){
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          } share", style: bodyText1Style.copyWith(
                                          color: Colors.blue.shade400,
                                              fontWeight: FontWeight.w300,
                                              fontSize: 10.sp))
                                        ],
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Text("Forword", style: bodyText1Style.copyWith(
                                              color: Colors.blue.shade400,
                                              fontWeight: FontWeight.w300,
                                              fontSize: 10.sp))
                                        ],
                                      ...
                                      Column(
                                        children: [
                                                    ...
                                                    AlertDialog(
                                                      ...
                                                      actions: <Widget>[
                                                        ...
                                                        TextButton(
                                                          onPressed: ()  async{
                                                            bool? status =
                                                           await controller.deletePostCommunityApi(controller.myAskModel.value.data![index].id.toString());
                                                            if(status){
                                                              controller.communityModel.refresh();
                                                            }
                                          ...
                                          Text("Delete", style: bodyText1Style.copyWith(
                                              color: Colors.red,
                                              fontWeight: FontWeight.w300,
                                              fontSize: 10.sp))
                                        ],
