        ...
        [
          Positioned(
            ...
            child:  Lottie.asset('assets/json/csc.json',
             ...
             ,fit:BoxFit.fill),height: 300.h,width: Get.width,),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: heading3.copyWith(fontSize: 25.sp),textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 10.h,),
                  Text('Many Voices,One Movement',
                    style: heading3.copyWith(fontSize: 25.sp,fontWeight: FontWeight.w300),textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 10.h,),
                  Text(
                      ' Towards a Digitally Empowered & Networked Society ',
                    style: heading3.copyWith(fontSize: 12.sp,fontWeight: FontWeight.w300),textAlign: TextAlign.center,
                  ),
                ],
              ),
            ),
